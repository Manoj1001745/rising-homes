          ...
          <div className="footer-top">
            <div className="row">
              <div className="col-md-6 col-lg-3 about-footer">
                ...
                <ul>
                  <li><a href="tel:(010) 1234 4321"><i className="fas fa-phone fa-flip-horizontal" />(010) 1234 4321</a></li>
              ...
              <div className="col-md-6 col-lg-4 open-hours">
                ...
                <table className="table">
                  <tbody>
                    <tr>
                      <td><i className="far fa-clock" />Monday Thursday</td>
                      <td>9:00am - 5:00pm</td>
                    </tr>
                    <tr>
                      <td><i className="far fa-clock" />Friday</td>
                      <td>9:00am - 4:00pm</td>
                    </tr>
                    <tr>
                      <td><i className="far fa-clock" />Sa turday</td>
                      <td>9:00am - 1:30pm</td>
                    </tr>
                    <tr>
                      <td><i className="far fa-clock" />Sunday</td>
