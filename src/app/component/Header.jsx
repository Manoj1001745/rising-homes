...
  }, []);
  return (
   <>
   <header id='head'>
   <nav className="navbar navbar-expand-sm navbar-dark header-bg">
  <div className="container">
      <Link className="navbar-brand" href="/">
            <Image src="/logo.png" width={0}
      height={0}
      sizes="100vw"
    ...
    <div className="collapse navbar-collapse" id="collapsibleNavId">
      <ul className="navbar-nav ms-auto mt-2 mt-lg-0 gap-5">
        ...
        <li className="nav-item">
          <Link className="nav-link " href="/login"><img className='acc-icon' src="./acc.png" alt="account-icon" /></Link>
        </li>
